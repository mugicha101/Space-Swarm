...
public class SniperBullet extends Bullet {
  public SniperBullet(Core parentCore, Weapon parentWeapon, Position pos, double dir) {
    ...
    bullet.setFill(new RadialGradient(0, 0, 0, 0, radius*1.5, false, CycleMethod.NO_CYCLE, new Stop(0.5, Color.WHITE), new Stop(0.8, Color.BLUE)));
