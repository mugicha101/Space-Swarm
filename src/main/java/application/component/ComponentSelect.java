...
public class ComponentSelect {
    ...
    private ComponentSelect(Position pos, SpriteAction spriteAction, String name, String description, ClickAction clickAction) {
        this.name = name;
        ...
        group.getChildren().addAll(box, nameLabel, descLabel);
